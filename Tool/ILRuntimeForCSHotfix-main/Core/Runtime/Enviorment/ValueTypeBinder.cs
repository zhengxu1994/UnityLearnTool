...
namespace CSHotFix.Runtime.Enviorment
{
        ...
        where T : struct
    {
        ...
        public void WriteBackValue(CSHotFix.Runtime.Enviorment.AppDomain domain, StackObject* ptr_of_this_method, IList<object> mStack, ref T instance_of_this_method)
        {
