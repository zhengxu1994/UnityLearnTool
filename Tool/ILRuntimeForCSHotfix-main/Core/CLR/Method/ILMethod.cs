...
namespace CSHotFix.CLR.Method
{
    public class ILMethod : IMethod
    {
        ...
        CSHotFixMethodInfo refletionMethodInfo;
        CSHotFixConstructorInfo reflectionCtorInfo;
        ...
        public MethodInfo ReflectionMethodInfo
        {
            get
            {
                ...
                if (refletionMethodInfo == null)
                    refletionMethodInfo = new CSHotFixMethodInfo(this);
        ...
        public ConstructorInfo ReflectionConstructorInfo
        {
            get
            {
                ...
                if (reflectionCtorInfo == null)
                    reflectionCtorInfo = new CSHotFixConstructorInfo(this);
