...
{
    unsafe class UnityEngine_UI_Mask_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.UI.Mask);
            args = new Type[]{};
            method = type.GetMethod("get_rectTransform", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_rectTransform_0);
            args = new Type[]{};
            method = type.GetMethod("get_showMaskGraphic", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_showMaskGraphic_1);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_showMaskGraphic", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_showMaskGraphic_2);
            args = new Type[]{};
            method = type.GetMethod("get_graphic", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_graphic_3);
            args = new Type[]{};
            method = type.GetMethod("MaskEnabled", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, MaskEnabled_4);
            ...
            app.RegisterCLRMethodRedirection(method, IsRaycastLocationValid_5);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.UI.Mask[s]);
        ...
        static StackObject* MaskEnabled_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.MaskEnabled();
