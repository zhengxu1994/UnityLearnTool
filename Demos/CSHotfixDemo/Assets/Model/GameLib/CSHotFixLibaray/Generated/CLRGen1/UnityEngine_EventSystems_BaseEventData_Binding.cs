...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_BaseEventData_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_currentInputModule_0);
            args = new Type[]{};
            method = type.GetMethod("get_selectedObject", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_selectedObject_1);
            args = new Type[]{typeof(UnityEngine.GameObject)};
            method = type.GetMethod("set_selectedObject", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_selectedObject_2);



            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.EventSystems.BaseEventData[s]);
        ...
        static StackObject* set_selectedObject_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
