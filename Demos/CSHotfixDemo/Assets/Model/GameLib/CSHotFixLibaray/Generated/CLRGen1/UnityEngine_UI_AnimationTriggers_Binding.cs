...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_AnimationTriggers_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("get_selectedTrigger", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_selectedTrigger_6);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("set_selectedTrigger", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_selectedTrigger_7);
            args = new Type[]{};
            method = type.GetMethod("get_disabledTrigger", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_disabledTrigger_8);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("set_disabledTrigger", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_disabledTrigger_9);
        ...
        static StackObject* get_selectedTrigger_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.selectedTrigger;

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* set_selectedTrigger_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            instance_of_this_method.selectedTrigger = value;

            return __ret;
        }

        static StackObject* get_disabledTrigger_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_disabledTrigger_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
