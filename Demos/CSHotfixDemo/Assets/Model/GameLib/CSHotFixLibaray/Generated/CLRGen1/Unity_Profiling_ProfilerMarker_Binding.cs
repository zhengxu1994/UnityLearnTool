...
{
    unsafe class Unity_Profiling_ProfilerMarker_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Unity.Profiling.ProfilerMarker);
            args = new Type[]{};
            ...
            args = new Type[]{};
            method = type.GetMethod("Auto", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Auto_3);


            app.RegisterCLRMemberwiseClone(type, PerformMemberwiseClone);

            app.RegisterCLRCreateDefaultInstance(type, () => new Unity.Profiling.ProfilerMarker());
            app.RegisterCLRCreateArrayInstance(type, s => new Unity.Profiling.ProfilerMarker[s]);

            args = new Type[]{typeof(System.String)};
            method = type.GetConstructor(flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Ctor_0);
            args = new Type[]{typeof(Unity.Profiling.ProfilerCategory), typeof(System.String)};
            method = type.GetConstructor(flag, null, args, null);
        ...
        static StackObject* Begin_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.Object @contextUnityObject = (UnityEngine.Object)typeof(UnityEngine.Object).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.Begin(@contextUnityObject);
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Unity.Profiling.ProfilerMarker(@category, @name);
