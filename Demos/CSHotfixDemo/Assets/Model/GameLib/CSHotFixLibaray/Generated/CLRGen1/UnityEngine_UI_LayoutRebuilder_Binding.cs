...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_UI_LayoutRebuilder_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ForceRebuildLayoutImmediate_2);
            args = new Type[]{typeof(UnityEngine.UI.CanvasUpdate)};
            method = type.GetMethod("Rebuild", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Rebuild_3);
            args = new Type[]{typeof(UnityEngine.RectTransform)};
            method = type.GetMethod("MarkLayoutForRebuild", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, MarkLayoutForRebuild_4);
            args = new Type[]{};
            method = type.GetMethod("LayoutComplete", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, LayoutComplete_5);
            args = new Type[]{};
            method = type.GetMethod("GraphicUpdateComplete", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GraphicUpdateComplete_6);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.UI.LayoutRebuilder());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.UI.LayoutRebuilder[s]);
        ...
        static StackObject* ForceRebuildLayoutImmediate_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* MarkLayoutForRebuild_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* LayoutComplete_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetHashCode_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
