...
{
    unsafe class UnityEngine_UI_ILayoutElement_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.UI.ILayoutElement);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_minWidth_2);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_flexibleWidth_4);
            args = new Type[]{};
            method = type.GetMethod("get_minHeight", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_minHeight_5);
            args = new Type[]{};
            method = type.GetMethod("get_preferredHeight", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_preferredHeight_6);
            args = new Type[]{};
            method = type.GetMethod("get_flexibleHeight", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_flexibleHeight_7);
            args = new Type[]{};
            method = type.GetMethod("get_layoutPriority", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_layoutPriority_8);



            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.UI.ILayoutElement[s]);
        ...
        static StackObject* get_flexibleWidth_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_minHeight_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_preferredHeight_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_flexibleHeight_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_layoutPriority_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
