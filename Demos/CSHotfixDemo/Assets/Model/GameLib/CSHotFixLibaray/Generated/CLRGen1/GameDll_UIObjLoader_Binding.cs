...
{
    unsafe class GameDll_UIObjLoader_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GameDll.UIObjLoader);
            args = new Type[]{};
            method = type.GetMethod("Init", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Init_0);
            args = new Type[]{typeof(System.String), typeof(System.String), typeof(UnityEngine.Transform), typeof(System.Action<System.Object>)};
            ...
            args = new Type[]{};
            method = type.GetMethod("Destory", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Destory_3);



            app.RegisterCLRCreateDefaultInstance(type, () => new GameDll.UIObjLoader());
            app.RegisterCLRCreateArrayInstance(type, s => new GameDll.UIObjLoader[s]);
        ...
        static StackObject* Init_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameDll.UIObjLoader instance_of_this_method = (GameDll.UIObjLoader)typeof(GameDll.UIObjLoader).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Load_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<System.Object> @call = (System.Action<System.Object>)typeof(System.Action<System.Object>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.Load(@abName, @assetName, @parent, @call);
        ...
        static StackObject* Destory_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            instance_of_this_method.Destory();
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new GameDll.UIObjLoader();
