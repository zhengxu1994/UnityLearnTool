...
{
    unsafe class UnityEngine_UI_PositionAsUV1_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.UI.PositionAsUV1);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.UI.PositionAsUV1[s]);
        ...
        static StackObject* ModifyMesh_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.PositionAsUV1 instance_of_this_method = (UnityEngine.UI.PositionAsUV1)typeof(UnityEngine.UI.PositionAsUV1).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
