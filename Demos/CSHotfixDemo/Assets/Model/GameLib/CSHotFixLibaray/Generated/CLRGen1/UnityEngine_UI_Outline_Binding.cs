...
{
    unsafe class UnityEngine_UI_Outline_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.UI.Outline);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.UI.Outline[s]);
