...
namespace CSHotFix.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_IPointerExitHandler_Binding
    {
        ...
        static StackObject* OnPointerExit_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.EventSystems.IPointerExitHandler instance_of_this_method = (UnityEngine.EventSystems.IPointerExitHandler)typeof(UnityEngine.EventSystems.IPointerExitHandler).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
