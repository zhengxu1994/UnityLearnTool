...
{
    unsafe class GameDll_IBattle_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GameDll.IBattle);
            args = new Type[]{};
            ...
            method = type.GetMethod("FpsUpdate", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, FpsUpdate_2);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new GameDll.IBattle());
            app.RegisterCLRCreateArrayInstance(type, s => new GameDll.IBattle[s]);
        ...
        static StackObject* Init_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameDll.IBattle instance_of_this_method = (GameDll.IBattle)typeof(GameDll.IBattle).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* FpsUpdate_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            instance_of_this_method.FpsUpdate(@t);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new GameDll.IBattle();
