...
{
    unsafe class UnityEngine_UI_ICanvasElement_Binding
    {
        public static void Register(CSHotFix.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, LayoutComplete_2);
            args = new Type[]{};
            method = type.GetMethod("GraphicUpdateComplete", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GraphicUpdateComplete_3);
            args = new Type[]{};
            method = type.GetMethod("IsDestroyed", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, IsDestroyed_4);



            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.UI.ICanvasElement[s]);


        }


        static StackObject* Rebuild_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* GraphicUpdateComplete_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            CSHotFix.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
