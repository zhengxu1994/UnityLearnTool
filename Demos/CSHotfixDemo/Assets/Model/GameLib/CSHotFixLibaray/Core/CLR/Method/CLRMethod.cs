...
namespace CSHotFix.CLR.Method
{
    public class CLRMethod : IMethod
    {
        ...
        internal CLRMethod(MethodInfo def, CLRType type, CSHotFix.Runtime.Enviorment.AppDomain domain)
        {
            this.def = def;
            declaringType = type;
        ...
        internal CLRMethod(ConstructorInfo def, CLRType type, CSHotFix.Runtime.Enviorment.AppDomain domain)
        {
            this.cDef = def;
            declaringType = type;
            this.appdomain = domain;
        ...
        public unsafe object Invoke(Runtime.Intepreter.ILIntepreter intepreter, StackObject* esp, IList<object> mStack, bool isNewObj = false)
        {
            ...
            else
            {
                ...
                if (!def.IsStatic)
                {
                    ...
                    if (!(instance is Reflection.CSHotFixWrapperType))
