...
namespace CSHotFix.Runtime
{
    public static class Extensions
    {
        ...
        {
            if (value is CSHotFix.Runtime.Enviorment.CrossBindingAdaptorType)
                return ((CSHotFix.Runtime.Enviorment.CrossBindingAdaptorType)value).ILInstance.Type.ReflectionType;
            if (value is CSHotFix.Runtime.Intepreter.ILTypeInstance)
                return ((CSHotFix.Runtime.Intepreter.ILTypeInstance)value).Type.ReflectionType;
            else
