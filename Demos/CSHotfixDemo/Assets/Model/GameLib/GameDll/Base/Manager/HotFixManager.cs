...
public class HotFixManager
{
    ...
    public bool Load(string dllName)
    {
        ...
        else if (Application.platform == RuntimePlatform.WindowsEditor || Application.platform == RuntimePlatform.OSXEditor)
        {
            ...
            dll_path = Application.streamingAssetsPath + "/" + dllName.ToLower() + ".dll";
        ...
        if (Application.platform == RuntimePlatform.WindowsEditor || Application.platform == RuntimePlatform.OSXEditor)
        {
            ...
            FileStream fileStream = File.OpenRead(Application.streamingAssetsPath + "/" + dllName.ToLower() + ".dll.pdb");
            if (fileStream != null && fileStream.Length > 0)
            {
                byte[] byteData = new byte[fileStream.Length];
                fileStream.Read(byteData, 0, (int)fileStream.Length);
