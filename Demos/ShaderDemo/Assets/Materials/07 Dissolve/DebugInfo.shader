	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = float4( i.ase_texcoord.xy, 0.0 , 0.0 );
				return finalColor;
			}
			ENDCG
		}
