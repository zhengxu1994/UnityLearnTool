...
namespace MoreMountains.Tools
{
                                    ...
                                    MMEventListener<MMSoundManagerTrackFadeEvent>
    {
        ...
        /// </summary>
        public virtual void SetVolumeMusic(float newVolume) { SetVolumeTrack(MMSoundManagerTracks.Music, newVolume);}
        /// <summary>
        /// Sets the volume of the SFX track to the specified value, QoL method, ready to bind to a UnityEvent
        /// </summary>
        public virtual void SetVolumeSfx(float newVolume) { SetVolumeTrack(MMSoundManagerTracks.Sfx, newVolume);}
        /// <summary>
        /// Sets the volume of the UI track to the specified value, QoL method, ready to bind to a UnityEvent
        /// </summary>
        public virtual void SetVolumeUI(float newVolume) { SetVolumeTrack(MMSoundManagerTracks.UI, newVolume);}
        /// <summary>
        /// Sets the volume of the Master track to the specified value, QoL method, ready to bind to a UnityEvent
        /// </summary>
        public virtual void SetVolumeMaster(float newVolume) { SetVolumeTrack(MMSoundManagerTracks.Master, newVolume);}
