Shader "YileShader/CustomEffect_Blend"{
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {                    //输出像素的时候 此处命名的i的信息就是上面o输出的信息 命名可改
                ...
                half3 FinalRGB = _Color.rgb * var_MainTex.rgb * _Indensity * i.color ;
                half op =var_MainTex.r * var_MainTex.a * var_MaskTex.r * var_MaskTex.a *  _Opacity   * i.color.a;
